        ...
        <div className="flex-1 border border-gray-300">
            ...
            <ul className="list-none p-0 m-0">
                    ...
                    <div>
                            ...
                            <div className="text-gray-600">Create a New payment</div>
                        </div>
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2a9.933 9.933 0 00-7.07 2.93C2.93 7.07 2 9.47 2 12s.93 4.93 2.93 7.07A9.933 9.933 0 0012 22a9.933 9.933 0 007.07-2.93C21.07 16.93 22 14.53 22 12s-.93-4.93-2.93-7.07A9.933 9.933 0 0012 2zm-1 13h2v2h-2v-2zm0-8h2v6h-2V7z"/></svg>
                    ...
                    <div>
                            ...
                            <div className="text-gray-600">Create a New benificiary</div>
                        </div>
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2a9.933 9.933 0 00-7.07 2.93C2.93 7.07 2 9.47 2 12s.93 4.93 2.93 7.07A9.933 9.933 0 0012 22a9.933 9.933 0 007.07-2.93C21.07 16.93 22 14.53 22 12s-.93-4.93-2.93-7.07A9.933 9.933 0 0012 2zm-1 13h2v2h-2v-2zm0-8h2v6h-2V7z"/></svg>
                    ...
                    <div>
                            ...
                            <div className="text-gray-600">View balance and details</div>
                        </div>
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2a9.933 9.933 0 00-7.07 2.93C2.93 7.07 2 9.47 2 12s.93 4.93 2.93 7.07A9.933 9.933 0 0012 22a9.933 9.933 0 007.07-2.93C21.07 16.93 22 14.53 22 12s-.93-4.93-2.93-7.07A9.933 9.933 0 0012 2zm-1 13h2v2h-2v-2zm0-8h2v6h-2V7z"/></svg>
                    ...
                    <div>
                            ...
                            <div className="text-gray-600">View Reports</div>
                        </div>
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2a9.933 9.933 0 00-7.07 2.93C2.93 7.07 2 9.47 2 12s.93 4.93 2.93 7.07A9.933 9.933 0 0012 22a9.933 9.933 0 007.07-2.93C21.07 16.93 22 14.53 22 12s-.93-4.93-2.93-7.07A9.933 9.933 0 0012 2zm-1 13h2v2h-2v-2zm0-8h2v6h-2V7z"/></svg>
